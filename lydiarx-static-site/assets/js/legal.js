...
const renderPrivacyPolicyPage = () => {
    ...
    `;
    document.getElementById('root').insertAdjacentHTML('beforeend', privacyPolicyPageContent);
}
...
const renderTermsOfServicePage = () => {
    ...
    `;
    document.getElementById('root').insertAdjacentHTML('beforeend', termsOfServicePageContent);
}


const renderModernSlaveryPage = () => {
    const modernSlaveryPageContent = `
    <main class="main-wrapper">
        <section class="section_product-header">
            <div class="page-padding">
                <div class="container-large" style="position: relative;">
    ...
    `;
    document.getElementById('root').insertAdjacentHTML('beforeend', renderModernSlaveryPage);
}
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (window.location.pathname.includes('modern-slavery.html')) {
        renderModernSlaveryPage();
    }
});
