...
const renderAboutPage = () => {
            ...
            <div class="page-padding">
                <div class="container-large" style="position: relative;">
                    ...
                    <div class="about_header_shapes">
                        <img src="./assets/images/LydiaRx_web-art.svg" class="about_header-image"/>
                    </div>
                </div> 
            </div>
        </section>
                        ...
                        <div class="about_component">
                            ...
                            <div class="margin-vertical margin-xxlarge">
                                <div class="about_image-wrapper">
                                    <img src="./assets/images/LydiaRx_about-us.jpeg" class="about_image"/>
                                </div>
                            </div>
                            <div class="max-width-large">
                                <h2>What we do</h2>
    ...
    root.insertAdjacentHTML('beforeend', aboutPageContent);
}
